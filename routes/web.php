...
Route::group(['prefix' => 'secure'], function () {
    ...
    // APP\USERLYRICTRACK
    Route::apiResource('user-lyric-track', 'UserLyricTrackController');

    // APP\USERTRACK
    Route::apiResource('user-track', 'UserTrackController');

    // APP\USERFAVORITE
    Route::apiResource('user-favorite', 'UserFavoriteController');
});
